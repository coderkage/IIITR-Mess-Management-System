...
<div class="container" style="margin-top: 50px;">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <h3 class="text-center">Complaint Resolution</h3>
            </div>
        </div>
    </div>
<hr>
                ...
                <table class="table table-bordered table-striped table-dark">
                    ...
                    <tbody>
                        ...
                        while ($row = mysqli_fetch_assoc($resolved_complaint_result)) {
                            echo "<tr>";
                            echo "<td>" . $row['complaint'] . "</td>";
                            echo "<td><img src='" . $row['image_path'] . "' alt='Complaint Image' style='max-width: 100px; max-height: 100px; cursor: pointer;' onclick=\"window.open('" . $row['image_path'] . "', '_blank')\"></td>";
                            echo "<td>" . $row['complain_date'] . "</td>";
